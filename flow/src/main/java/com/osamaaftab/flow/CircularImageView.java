...
public class CircularImageView extends AppCompatImageView {
    ...
    private ProgressBarListener onChangeListener;
    ...
    public CircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderOverlay = a.getBoolean(R.styleable.ImageView_border_overlay, DEFAULT_BORDER_OVERLAY);
        mDrawAntiClockwise = a.getBoolean(R.styleable.ImageView_draw_anticlockwise, DEFAULT_DRAW_ANTI_CLOCKWISE);
        mEnableTouch = a.getBoolean(R.styleable.ImageView_enable_touch, DEFAULT_ENABLE_TOUCH);
        mFillColor = a.getColor(R.styleable.ImageView_fill_color, DEFAULT_FILL_COLOR);
        mInnrCircleDiammeter = a.getFloat(R.styleable.ImageView_centercircle_diammterer, DEFAULT_INNTER_DAIMMETER_FRACTION);
        mProgressColor = a.getColor(R.styleable.ImageView_progress_color, DEFAULT_PROGRESS_COLOR);
        mBaseStartAngle = a.getFloat(R.styleable.ImageView_progress_startAngle, 0);
    ...
    public void setOnCircularBarChangeListener(ProgressBarListener listener) {
        ...
        gestureListener = new GestureDetector(context, new GestureDetector.OnGestureListener() {
            ...
            public boolean onDown(MotionEvent motionEvent) {
                if (computeInArea(motionEvent.getX(), motionEvent.getY())) {
                    ...
                    if (onChangeListener != null) {
                        onChangeListener.onClick(CircularImageView.this);
                    }
                    postInvalidate();
                    return true;
            ...
            public void onLongPress(MotionEvent motionEvent) {
                if (onChangeListener != null) {
                    onChangeListener.onLongPress(CircularImageView.this);
                }
            }
